...
Edit each section by clicking the pencil icon next to it on your profile page.
...
## 3. Top 5 Skills (replace the current 5 Android synonyms)
...
| Order | Type | Item | URL |
|---|---|---|---|
| 1 | Document | Resume PDF | (already pinned — re-export from `src/cv/Hussain_Gaddal_CV.html`) |
| 2 | Link | Portfolio | https://ironmanyg.github.io/hussain-portfolio/ |
| 3 | Link | GitHub profile | https://github.com/IronManYG |
| 4 | Link | Top project (Chirp) | https://ironmanyg.github.io/hussain-portfolio/chirp/ |

---

## 5. Experience — Android Developer (Mar 2022 – Present)

Replace the current "Skills: Kotlin, Compose, +1 skill" with:
...
**Skills to attach to this role:** Kotlin, Jetpack Compose, KMP, CMP, Ktor, Clean Architecture, MVI, CI/CD.

---

## 6. Experience — Researcher (Sep 2017 – Mar 2022)

Currently empty on LinkedIn. Add:
...
> Portfolio: https://ironmanyg.github.io/hussain-portfolio/chirp/
...
> Portfolio: https://ironmanyg.github.io/hussain-portfolio/scribbledash/
...
> Portfolio: https://ironmanyg.github.io/hussain-portfolio/echojournal/
...
> Portfolio: https://ironmanyg.github.io/hussain-portfolio/runique/
...
> Portfolio: https://ironmanyg.github.io/hussain-portfolio/maktabati/
...
LinkedIn currently says "Electrical and Electronics Engineering" while the CV/site say "Bachelor (Honors) of Electrical Engineering". Pick one canonical label across all surfaces. Recommend:
...
LinkedIn is missing these from the CV/site:

1. **Building Industry-Level CMP Desktop Apps** — Pl-Coding (JetBrains-collaborated), 2025
2. **Building Industry-Level CMP Android & iOS** — Pl-Coding (JetBrains-collaborated), 2025
3. **Kotlin Backends With Spring Boot** — Pl-Coding (JetBrains-collaborated), 2025
