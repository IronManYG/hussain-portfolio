...
| CV (`src/cv/Hussain_Gaddal_CV.html`) | ✅ in sync | Researcher nested under Kay Technology; PDF needs re-export |
| CV PDF (`src/cv/Hussain_Gaddal_CV.pdf`) | ⚠️ stale | Re-export from current HTML (see `src/social/cv.md`) |
